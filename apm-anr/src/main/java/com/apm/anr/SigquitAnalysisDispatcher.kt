 ...
 */
internal class SigquitAnalysisDispatcher(private val schedule: (() -> Unit) -> Boolean) {
     ...
     */
    fun dispatch(running: Boolean, anrDetected: AtomicBoolean, analysis: () -> Unit): Boolean {
        if (!running) {
            return false
        }
