...
monitor module
  ...
  -> bounded dispatcher queue (2048; default 75% high-water / 50% per-module NORMAL/LOW share; higher priority may evict the oldest lower-priority entry; producers never wait)
