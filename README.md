...
由于插件仍基于 legacy Transform API，`gradle.properties` 中保留了 `android.experimental.legacyTransform.forceNonIncremental=true` 兼容开关。
...
| apm-plugin | Gradle 插件 | included build，提供 ASM 字节码插桩 Transform |
