 ...
 * ```xml
 * <provider
 *     android:name="com.didi.apm.core.ApmInitProvider"
 ...
 * ```xml
 * <meta-data
 *     android:name="com.didi.apm.config_class"
...
class ApmInitProvider : ContentProvider() {
     ...
     *
     * 执行流程：
     * 1. 读取 AndroidManifest 中 `com.didi.apm.config_class` meta-data
    ...
    override fun onCreate(): Boolean {
        ...
        if (configClassName.isNullOrBlank()) {
            ...
            Log.w(TAG, "No meta-data 'com.didi.apm.config_class' found, skip auto-init")
            return true
        }
    ...
    companion object {
        ...
        private const val META_DATA_KEY_CONFIG_CLASS = "com.didi.apm.config_class"
    }
}
