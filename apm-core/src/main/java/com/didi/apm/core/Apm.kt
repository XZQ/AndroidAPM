...
import com.didi.apm.storage.FileEventStore
import com.didi.apm.core.throttle.RateLimiter
import com.didi.apm.uploader.ApmUploader
import com.didi.apm.uploader.LogcatApmUploader
import com.didi.apm.uploader.RetryingApmUploader
    ...
    private fun doInit(application: Application, config: ApmConfig) {
        ...
        val uploader: ApmUploader = if (config.enableRetry) {
            RetryingApmUploader(
                ...
                retryPolicy = com.didi.apm.uploader.RetryPolicy(
