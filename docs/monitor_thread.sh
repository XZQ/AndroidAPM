...
# AndroidAPM sample thread trend and per-thread CPU helper.
# Override the defaults through environment variables for another package.
...
KILL_WAIT_SEC="${KILL_WAIT_SEC:-2}"
TOP_N="${TOP_N:-5}"
OUT_DIR="${OUT_DIR:-thread_reports}"
